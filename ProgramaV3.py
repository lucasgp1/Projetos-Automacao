...
comando_puxa_antenas = """SELECT [Modelo]
...
print(type(lista_modelos_antenas))
...
combobox_selecionar_tipo_solicitacao1 = ttk.Combobox(values=lista_tipos_solicitacao)
combobox_selecionar_tipo_solicitacao1.grid(row=4, column=4, padx = 20, pady=10, sticky='nswe', columnspan = 2)
...
selected_equipamento = tk.StringVar()
combobox_selecionar_tipo_equipamento1 = ttk.Combobox(values=lista_tipos_equipamento, textvariable=selected_equipamento)
combobox_selecionar_tipo_equipamento1.grid(row=4, column=10, padx = 20, pady=10, sticky='nswe', columnspan = 2)
...
combobox_selecionar_tipo_modeloequipamento1 = ttk.Combobox(values=lista_modelos_antenas)
combobox_selecionar_tipo_modeloequipamento1.grid(row=4, column=18, padx = 20, pady=10, sticky='nswe', columnspan = 2)
