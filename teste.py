...
def gera_planilha(detentora_site, nome_site, codigo_site, cidade_site, estado_site, endereco_site, latitude_site, longitude_site):
    ...
    if detentora_site == "['SBA']":
        ...
        aba_ativa["D25"] = "PUXAR FABRICANTE"
...
def puxa_banco():
    ...
    try:
        ...
        gera_planilha(detentora_site, nome_site, codigo_site, cidade_site, estado_site, endereco_site, latitude_site,longitude_site)
...
def pega_antenas_rrus(event):
    ...
    if selected_equipamento.get() == "RRU":
        combobox_tipomodeloequipamento1.config(value=lista_modelos_rrus)
    else:
        combobox_tipomodeloequipamento1.config(value=lista_modelos_antenas)
...
combobox_tipoequipamento1 = ttk.Combobox(values=lista_tipos_equipamento, textvariable=selected_equipamento)
